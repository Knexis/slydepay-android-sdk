...
public class PayWithSlydepay extends Activity{
    ...
    static public int resultCodeHere = 555;
                           ...
                           String idescription )
    {
        ...
        resultCodeHere   = 555;
        context.startActivityForResult(new Intent(context, PayWithSlydepay.class), resultCodeHere);
    }
        ...
        if(requestCode==1)
        {
            switch (resultCode){
                ...
                case RESULT_CANCELED:
                    resultCodeHere = RESULT_CANCELED;
